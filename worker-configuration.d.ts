/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b96aa6087ca206df294beeb11814a29f)
// Runtime types generated with workerd@1.20260625.1 2026-06-26 
interface __BaseEnv_Env {
	BLOBS: R2Bucket;
	DB: D1Database;
	CLIPBOARD: DurableObjectNamespace<import("./src/worker/index").ClipboardSpace>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "ClipboardSpace";
	}
