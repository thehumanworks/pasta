...
slug: protocol
description: Wire format, signing, encryption, and API endpoints for Pasta v0.1.12.
nav_order: 6
---
...
Protocol version aligns with **`pasta 0.1.12`**. Run `pasta protocol` for the live endpoint map from your installed CLI.
