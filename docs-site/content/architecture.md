...
Account IDs, routing IDs, device IDs, timestamps, sequence numbers, payload kind, MIME type, byte length, pairing activity, and IP-level request metadata. Pasta v0.1.19 does not attempt to hide usage patterns.
