...
Pasta v0.1.9 — terminal-first encrypted clipboard relay. Central Cloudflare Worker transport only. Devices encrypt locally; relay stores ciphertext.
...
```bash
bunx --bun -p github:thehumanworks/pasta pasta --version   # expect 0.1.9
