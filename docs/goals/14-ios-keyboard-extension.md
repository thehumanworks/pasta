...
- 2026-06-28 - TestFlight build 16 for keyboard casing/Shift contrast follow-up - `archive_upload.sh` with `SCHEME=Pasta`, `CONFIGURATION=Release`, `DEVELOPMENT_TEAM=54MXM5JG3R`, `APP_STORE_CONNECT_API_PRIVATE_KEY_PATH=ios/build/asc/AuthKey.p8`, `EXPECT_NO_NON_EXEMPT_ENCRYPTION=1`, and `TESTFLIGHT_BETA_GROUP_NAME=internal` - exit 0; archive/export/upload passed and produced `ios/build/export-0.1.9-16/Pasta.ipa`.
- 2026-06-28 - TestFlight build 16 IPA inspection - `inspect_ipa.sh ios/build/export-0.1.9-16/Pasta.ipa` - exit 0; bundle `com.thehumanworks.pasta`, version `0.1.9`, build `16`, SDK `iphoneos27.0`, `ITSAppUsesNonExemptEncryption=false`, `beta-reports-active=true`, `get-task-allow=false`, distribution profile, and embedded `PastaKeyboard.appex`.
- 2026-06-28 - TestFlight build 16 App Store Connect proof - `testflight-release.log` shows App Store Connect app `6785005536`, build `2f0730b9-e0d9-4fbe-b758-9463567f7f6b`, version `16`, `processingState=VALID`, `expired=false`, `usesNonExemptEncryption=false`; internal group `internal` (`91ffd61d-626c-44e4-ab22-552d858c3d0b`) has `hasAccessToAllBuilds=True`.
